        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              using (OleDbDataReader reader = command.ExecuteReader())
              {
                  ...
                  txtAuthor.Text = reader["Auther"].ToString();
...
{DataLink.libConnection.Close();
        ...
        {
            bool result= DataLink.runOleDbCommand("INSERT INTO tbl_book(BookName, BookPrice, Author, Category, Status) values ('"+txtBookName.Text+"',"+  txtBookPrice.Text+",'"+txtAuthor.Text+"','"+cmbCategory.Text+"','In Stock');");
        ...
        {
            bool result = DataLink.runOleDbCommand("DELETE*FROM tbl_book where BookID=" + txtIsbnNumber.Text + ";");
        ...
        {
            bool result = DataLink.runOleDbCommand("UPDATE tbl_book SET tbl_book.BookName='" + txtBookName.Text + "',tbl_book.BookPrice=" + txtBookPrice.Text + ",tbl_book.Author='" + txtAuthor.Text + "',tbl_book.Category='" + cmbCategory.Text + "'WHERE BookID=" + txtIsbnNumber.Text + ";");
